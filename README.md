...
総合カリエスリスクは、環境項目（う蝕経験・関連全身疾患）を合計から除外し、食事・細菌・感受性の項目を合計した21点満点で表示します。環境項目は表と個別説明には残し、参考情報として確認できます。
DMFTは、厚生労働省「令和6年歯科疾患実態調査」表9・10の最新全国平均をもとに、患者年齢に対応する平均値と紙の記入欄に入力したDMFT値をレポート内の別枠グラフで表示します。
